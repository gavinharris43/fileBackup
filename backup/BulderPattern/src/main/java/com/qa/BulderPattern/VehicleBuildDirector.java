...
public class VehicleBuildDirector {
	...
	public Vehicle construct() {
		return builder.setWheels(4).setRegistration("PJ59ZMZ").setLenghtMeaters(3).setType("Car").build();

	}

	public Vehicle construct1() {
		return builder.setWheels(2).setRegistration("PJ10HGL").setLenghtMeaters(3).setType("Bike").build();
	}
	...
	public static void main(final String[] arguments) {
		...
		System.out.println(vehicleBuildDirector.construct1());
	}
}