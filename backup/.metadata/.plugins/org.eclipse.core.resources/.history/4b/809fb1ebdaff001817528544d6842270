...
public class Game {
	...
	public void tresure() {
		...
		// System.out.println(positionX+" "+positionY+" "+ tresurePositionX+"
		// "+tresurePositionY);
		//System.out.println(positionX+" "+positionY+" milk "+ milk.getPositionX()+" "+milk.getPositionY() +" nut: "+ nut.getPositionX()+" "+nut.getPositionY());
	}

	public void alergyInfo() {

		System.out
				.print("Defalt: nuts \n Defalt Movemrnt: North \n Time to chose your dealy alergy, You have a choise, "
						+ nuts + ", " + dary + ", " + bees + "? ");
	}
	...
	public void getyourPosition() {
		// System.out.print("Your position is "+positionX+" "+positionY+ "tresure is at
	...
	public void trap() {
		if (positionX == nut.getPositionX() && positionY == nut.getPositionY()) {
			if (nuts.equals(alergy)) {
				System.out.println("You Found a tresure box and open it, " + alergy
						+ " explodes into your face, You swell up like a bollon and you pop! \n GAME OVER!");
				System.exit(0);
			} else {
				System.out.println("You Found a tresure box and open it, " + nuts
						+ " explodes into your face, Good fortune is on your side as your alergic to " + alergy);
			}
		}
		if (positionX == milk.getPositionX() && positionY == milk.getPositionY()) {
			if (dary.equals(alergy)) {
				...
				System.out.println("You Found a tresure box and open it, " + dary
						+ " explodes into your face, Good fortune is on your side as your alergic to " + alergy);
			}
		}
		if (positionX == bee.getPositionX() && positionY == bee.getPositionY()) {
			if (bees.equals(alergy)) {
				...
				System.out.println("You Found a tresure box and open it, " + bees
						+ " explodes into your face, Good fortune is on your side as your alergic to " + alergy);
			}
		}
	}
