...
public class Bike extends Vehicle {
	...
	public Bike(int manufactureYear, Double engineSixe, int wheels, String registration, String make,
			int lengthMeters) {
		super(manufactureYear, engineSixe, wheels, registration, make, lengthMeters);
		// TODO Auto-generated constructor stub
	}

	public Bike(String registration, int lengthMeters, int wheels) {
